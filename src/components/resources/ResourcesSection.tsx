  ...
  return (
    <section className="w-full py-16 px-4 sm:px-6 lg:px-8">
      <div className="container mx-auto">
        ...
        <div className="absolute top-[12%] md:top-[18%] xl:right-[30%] lg:right-[22%] md:right-[12%] right-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Right side - Content */}
          <div className="relative space-y-8 mt-16 lg:mt-0">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
                Accelerate development with professional-grade code, schematics,
              ...
              <ul className="space-y-1">
                <li className="flex items-center">
                  ...
                  <span className="text-gray-700 text-sm leading-relaxed">
                    C/Assembly code from real firmware projects
                  </span>
                </li>
                <li className="flex items-center">
                  <span className="flex-shrink-0 w-1 h-1 bg-text-primary rounded-full mr-4"></span>
                  <span className="text-gray-700 text-sm leading-relaxed">
                    Simulink models for converter & motor control
                  </span>
                </li>
                <li className="flex items-center">
                  <span className="flex-shrink-0 w-1 h-1 bg-text-primary rounded-full mr-4"></span>
                  <span className="text-gray-700 text-sm leading-relaxed">
                    Technical PDFs and documentation
                  </span>
                </li>
              </ul>
            </div>
